    ...
    <div class="scroll-container">
      ...
      <div class="step-card":class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Ontology Generate</span>
          </div>
          <div class="step-status">
            <span v-if="currentPhase > 0" class="badge success">Already Complete</span>
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM analyzes document content and simulation requirements, auto-generates ontology 
          </p>
      ...
      <div class="step-card":class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="currentPhase > 1" class="badge success">Already Complete</span>
        ...
        <div class="card-content">
          ...
          <p class="description">
             After ontology generated, document auto-calls Zep to build knowledge graph with entity relations and summaries
          </p>
      ...
      <div class="step-card":class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="currentPhase >= 2" class="badge accent">Ready to Run</span>
          </div>
        </div>
        
        <div class="card-content">
          <p class="api-note">POST /api/simulation/create</p>
          <p class="description">Graph build already complete, please proceed to simulation environment setup</p>
          <button 
            class="action-btn" 
          ...
          >
            ...
            {{ creatingSimulation? 'Creating...': 'Setup Environment ➝' }}
          </button>
        </div>
      </div>
    </div>
...
const handleEnterEnvSetup = async () => {
  if (!props.projectData?.project_id ||!props.projectData?.graph_id) {
    console.error(' project graphinfo')
    return
  }
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      ...
      alert('Createsimulationfailed: ' + (res.error || 'unknown error'))
    }
  } catch (err) {
    console.error('Create simulation:', err)
    alert('Create simulation: ' + err.message)
  } finally {
...
.badge.processing { background: #638cff; color: #fff; }
.badge.accent { background: #638cff; color: #fff; }
.badge.pending { background: rgba(255, 255, 255, 0.04); color: rgba(255, 255, 255, 0.3); }
