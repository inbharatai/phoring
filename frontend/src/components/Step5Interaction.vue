          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent? selectedAgent.username: ' ' }}</span>
                <svg class="dropdown-arrow":class="{ open: showAgentDropdown }" viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2">
                  <polyline points="6 9 12 15 18 9"></polyline>
                </svg>
              </button>
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header"> object</div>
                <div 
                ...
                >
                  ...
                  <div class="agent-info">
                    ...
                    <span class="agent-role">{{ agent.profession || 'not yet ' }}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">reportgenerateagent, call 4 tool, Phoring complete </div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc"> data simulation environment status, Global/Local Memory, provide analyze</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">, eventspreadpath, info </div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc"> GraphRAG queryinterface, index, concrete nodeattribute </div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">, row simulation row round, opiniondata status</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="profile-card-header">
              ...
              <div class="profile-card-info">
                ...
                <div class="profile-card-meta">
                  ...
                  <span class="profile-card-profession">{{ selectedAgent.profession || 'not yet ' }}</span>
                </div>
              </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent'? ' Report Agent, reportcontent': ' simulation, opinion' }}
              </p>
            </div>
            <div 
        ...
        <div v-if="activeTab === 'survey'" class="survey-container">
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title"> object</span>
                <span class="selection-count">already {{ selectedAgents.size }} / {{ profiles.length }}</span>
              </div>
              <div class="agents-grid">
                ...
                >
                  ...
                  <div class="checkbox-info">
                    ...
                    <span class="checkbox-role">{{ agent.profession || 'not yet ' }}</span>
                  </div>
              ...
              <div class="selection-actions">
                <button class="action-link" @click="selectAllAgents"> </button>
          ...
          <div v-if="surveyResults.length > 0" class="survey-results">
            <div class="results-header">
              ...
              <span class="results-count">{{ surveyResults.length }} reply</span>
            </div>
              ...
              >
                <div class="result-header">
                  ...
                  <div class="result-info">
                    ...
                    <span class="result-role">{{ result.profession || 'not yet ' }}</span>
                  </div>
                </div>
...
const chatHistoryCache = ref({}) // cacheall record: { 'report_agent': [], 'agent_0': [], 'agent_1': [],... }
...
const sendMessage = async () => {
  ...
  try {
    ...
    scrollToBottom()
    // Auto-save record to cache
    saveChatHistory()
  }
}

const sendToReportAgent = async (message) => {
  addLog(` Report Agent: ${message.substring(0, 50)}...`)
  ...
  if (res.success && res.data) {
    ...
    addLog('Report Agent already replied')
  } else {
    throw new Error(res.error || 'please failed')
  }
}

const sendToAgent = async (message) => {
  if (!selectedAgent.value || selectedAgentIndex.value === null) {
    throw new Error('please simulation ')
  }
  
  addLog(` ${selectedAgent.value.username}: ${message.substring(0, 50)}...`)
  ...
  if (res.success && res.data) {
    // datapath: res.data.result.results object 
    // format: {"twitter_0": {...}, "reddit_0": {...}} platform {"reddit_0": {...}}
    const resultData = res.data.result || res.data
    const resultsDict = resultData.results || resultData
    
    // object convert, Get reddit platform reply
    let responseContent = null
    const agentId = selectedAgentIndex.value
    
    if (typeof resultsDict === 'object' &&!Array.isArray(resultsDict)) {
      // reddit platformreply, twitter
    ...
    if (responseContent) {
      ...
      addLog(`${selectedAgent.value.username} already replied`)
    } else {
...
const submitSurvey = async () => {
  ...
  addLog(` ${selectedAgents.value.size} object...`)
    ...
    if (res.success && res.data) {
      ...
      for (const interview of interviews) {
        ...
        if (typeof resultsDict === 'object' &&!Array.isArray(resultsDict)) {
          ...
          if (matchedResult) {
            responseContent = matchedResult.response || matchedResult.answer || ' '
          }
        }
      ...
      addLog(` ${surveyResults.value.length} reply`)
    } else {
      throw new Error(res.error || 'please failed')
    }
  } catch (err) {
...
const loadReportData = async () => {
  ...
  try {
    ...
    addLog(`loadreportfailed: ${err.message}`)
  }
}
...
const loadAgentLogs = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog('reportdataloadcomplete')
    }
  } catch (err) {
    addLog(`loadreportlogfailed: ${err.message}`)
  }
}
...
const loadProfiles = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`load ${profiles.value.length} simulation `)
    }
  } catch (err) {
    addLog(`loadsimulation failed: ${err.message}`)
  }
}
...
/* Left Panel - Report Style ( Step4Report.vue) */
.left-panel.report-style {
  width: 45%;
  min-width: 450px;
...
.tab-pill.active {
  background: #638cff;
  color: #FFFFFF;
  box-shadow: 0 2px 8px rgba(99, 140, 255, 0.25);
}
