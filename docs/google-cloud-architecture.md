...
|---|---|---|
| **Google Kubernetes Engine** | Hosts the containerized Phoring frontend + backend image (Autopilot cluster `phoring`, `asia-south1`) | `deploy/gke/manifests.yaml`, `deploy/gke/deploy.sh`, `deploy/gke/README.md` |
