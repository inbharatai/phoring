...
Zep node/edge list APIs use UUID-based cursor pagination.
This module handles automatic pagination (with retry) and returns complete lists.
"""
...
def _fetch_page_with_retry(
    ...
    **kwargs: Any,
    ...
    """Fetch a single page from a Zep API, retrying on connection/IO errors."""
    if max_retries < 1:
...
def fetch_all_nodes(
    ...
    """Fetch all nodes for a graph, up to max_items (default 2000). Retries on failure."""
    all_nodes: list[Any] = []
